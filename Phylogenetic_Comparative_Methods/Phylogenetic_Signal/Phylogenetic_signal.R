...
prunned_tree<-drop.tip(tree, tip = c("Guindilia_trinervis", "Talisia_nervosa", "Paullinia_sp._a",
...
#LogLik (lambda) = -120.3151 | LogLik (lambda=0) = -148.749 
cat("LR =", round(LR, 3), "| p =", signif(pval, 3), "\n")
#LR = 56.868 | p = 4.66e-14
