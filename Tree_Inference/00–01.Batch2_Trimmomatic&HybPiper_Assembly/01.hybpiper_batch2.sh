...
#SBATCH --job-name=01.hybpiper_batch2.sh
#SBATCH --nodes=1
...
# Read the corresponding line (based on SLURM_ARRAY_TASK_ID) from namelist_batch2.txt
namelist=$(sed -n "$((index + 1))p" /scratch/projects/onyenedumlab/Joyce_Onyenedum/paullinieae_phylogeny/scripts/namelist/namelist_batch2.txt)

# Define input and output directories
INPUT_DIR="/scratch/projects/onyenedumlab/Joyce_Onyenedum/paullinieae_phylogeny/00.trimmomatic/clean_data/batch2"
