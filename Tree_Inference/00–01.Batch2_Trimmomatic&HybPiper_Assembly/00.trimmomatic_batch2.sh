...
#!/bin/bash
#SBATCH --job-name=00.trimmomatic_batch2.sh
#SBATCH --nodes=1
...
INPUT_DIR="/scratch/projects/onyenedumlab/Joyce_Onyenedum/paullinieae_phylogeny/raw_data/batch2"
OUTPUT_DIR="/scratch/projects/onyenedumlab/Joyce_Onyenedum/paullinieae_phylogeny/00.trimmomatic/clean_data/batch2"
...
NAMELIST="/scratch/projects/onyenedumlab/Joyce_Onyenedum/paullinieae_phylogeny/scripts/namelist/namelist_batch2.txt"
