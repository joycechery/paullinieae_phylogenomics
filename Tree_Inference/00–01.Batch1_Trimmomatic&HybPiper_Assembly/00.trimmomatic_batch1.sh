#!/bin/bash
#SBATCH --job-name=00.trimmomatic_batch1.sh
#SBATCH --nodes=1
...
INPUT_DIR="/scratch/projects/onyenedumlab/Joyce_Onyenedum/paullinieae_phylogeny/raw_data/batch1"
OUTPUT_DIR="/scratch/projects/onyenedumlab/Joyce_Onyenedum/paullinieae_phylogeny/00.trimmomatic/clean_data/batch1"
...
NAMELIST="/scratch/projects/onyenedumlab/Joyce_Onyenedum/paullinieae_phylogeny/scripts/namelist/namelist_batch1.txt"
